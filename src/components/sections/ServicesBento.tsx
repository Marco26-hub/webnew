          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <span className="h-px w-8 bg-line-bright transition-all duration-500 group-hover:w-12" />
              </div>
              ...
              <div className={cn("mt-7 grid gap-4", wide && "sm:grid-cols-2")}>
                {p.services.map((s) => (
                  <div
                    key={s.id}
                    className="rounded-2xl border border-line bg-surface/40 p-4 transition-colors duration-300 group-hover:border-line-bright"
                  >
